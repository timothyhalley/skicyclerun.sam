...
export function getParams(event, bucketName, albumPath, numPhotos) {
    ...
    } else if (event.queryStringParameters && event.queryStringParameters.numPhotos && event.queryStringParameters.numPhotos !== "") {
    ...
    return [bucketName, albumPath, numPhotos];
}